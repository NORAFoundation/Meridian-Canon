...
Private keys are stored in the macOS Keychain via the keyring library
(restricted to the meridian-canon process identity). Public keys are
exported to PEM (RFC 8410) and must be hosted at a stable URL declared
in every Seal's public_key_url field.

Usage:
    private, public, fingerprint = keygen("white-dossier-2026")
    # Public PEM is written to ~/.meridian/keys/<fingerprint>.pem
    # Private key lives in Keychain under service 'meridian-canon',
